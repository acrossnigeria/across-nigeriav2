export default function Home() {
    return (
        <div style={{ border:'1px solid rgb(197, 244, 192)', padding:'3px', borderRadius:'6px'}} className="hover:opacity-70">
            <svg fill="rgb(197, 244, 192)" height="35px" width="35px" version="1.1" id="Capa_1" viewBox="0 0 360 360" >
