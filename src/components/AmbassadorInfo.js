...
const AmbassadorInfo = () => {
    return (
        <div className="w-[95%] border-1 border-green-500 pb-3 p-2 mt-[10px] ml-[2.5%] rounded-[13px] flex flex-col">
            ...
            <span className="mt-[5px] text-left md:text-center text-gray-400 text-[15px]">Become part of something big! Earn rewards, gain exclusive perks, and represent our brand in style.</span>
            <Link href={'/ambassador/apply'}><button className="h-[40px] md:self-center self-left mt-[10px] cursor-pointer hover:bg-green-700 w-[200px] bg-green-600 text-white rounded-[25px]">Join Now</button></Link>
        </div>
    )
}
