...
const BlogPostCard = (props) => {
    ...
    <Link href={link} style={{border:'0.5px solid rgb(206, 206, 206)', flexDirection:'column', borderRadius:'1.3rem', borderTop:'none', backgroundColor:'rgb(240, 240, 240)'}}>
      <div className="relative px-6 h-52 md:h-52 container flex-col gap-0 items-center mx-auto
       bg-transparent rounded-lg md:max-w-xl
       hover:opacity-85 w-full 
       md:w-200px] cursor-pointer bg-transparent">
