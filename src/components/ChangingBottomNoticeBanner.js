...
const ChangingBottomNoticeBanner = ( { adverts, isLoading } ) => {
    ...
    return (
        <div className='md:h-[220px] h-[120px] flex-row flex justify-between md:w-[100%] mx-auto w-[100%] mt-[20px] mb-[70px]'>
            { isLoading && (
                <>
                <div className="h-[100%] bg-gray-400 animate-pulse relative w-[49%]"></div> 
                <div className="h-[100%] bg-gray-400 animate-pulse relative w-[49%]"></div> 
                </>
            )}
            { !isLoading && (
