    ...
    return (
        <div className={`pb-[50px] ${isPlay===''?'hidden':''}`}>
            ...
            <div className="text-center mt-5" >
                <span style={{lineHeight:'25px', borderTopLeftRadius:'50px', borderBottomRightRadius:'50px'}} className="w-[50%] text-[25px] text-center bg-gradient-to-br px-5 py-1 from-purple-500 to-purple-900 text-white font-bold tracking-wider">How to Join the Fun</span> 
            </div>
            <div className={`${isMobile?'w-[90%] ml-[5%]':'w-[60%] ml-[20%]'} mt-[25px]`}>
                <div className="flex flex-row justify-evenly mt-[20px]">
                    ...
                    <div style={{borderTopRightRadius:'25px', borderBottomRightRadius:'25px', borderBottomLeftRadius:'25px'}} className={`bg-gray-100 ${isMobile?'w-[70%] text-[17px]':'text-[20px]'} max-w-[600px] text-purple-800 p-[10px]`}>
                ...
                <div className="flex flex-row justify-evenly mt-[20px]">
                    <div style={{borderTopLeftRadius:'25px', borderBottomLeftRadius:'25px', borderBottomRightRadius:'25px'}} className={`bg-gray-100 ${isMobile?'w-[70%] text-[17px]':'text-[20px]'} max-w-[600px] text-purple-800 p-[10px]`}>
                ...
                <div className="mt-[30px] border-t-1 border-green-300 pt-[10px] flex flex-col text-center gap-2">
                    ...
                    <button onClick={play} style={{alignSelf:'center', borderRadius:'20px'}} className="bg-gradient-to-br from-purple-500 to-purple-900 w-[fit-content] px-[50px] hover:text-gray-200 hover:bg-gradient-to-tl text-white font-bold py-[2px] text-[25px]"><a href="#top">Play</a></button>
                </div>
            </div>
