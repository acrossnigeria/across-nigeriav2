...
const Quiz = ( { state }) => {
  ...
  return (
    <div className={`flex mx-auto flex-col space-y-4 p-4 md:w-[600px] ${state} `}>
      ...
      <ul className="space-y-2 md:w-[350px]">
        { question.options.map((option, index) => (
          <li key={index} className={`p-2 rounded-md cursor-pointer hover:bg-gray-300 ${selectedAnswer === index ? 'bg-green-600 text-white':''}`} onClick={() => handleOptionClick(index)} >
            {option}
          </li>
        )) }
      </ul>

      <button className="py-2 px-4 bg-yellow-600  md:w-20 text-white rounded-md disabled:bg-gray-400 hover:bg-gray-900 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-400 disabled:cursor-not-allowed" disabled={selectedAnswer === null} onClick={handleNext}>
       submit
      </button>
        ...
        <div className="fixed inset-0 bg-gray-500/50 flex justify-center items-center z-50">
          <div className="bg-white p-4 rounded-md shadow-md">
            ...
            <div className="flex justify-end space-x-2 mt-4">
              <button className="py-2 px-4 bg-blue-500 text-white rounded-md hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-400" onClick={() => handleFinalAnswer(true)}>
                Yes
              </button>
              <button className="py-2 px-4 bg-gray-500 text-white rounded-md hover:bg-gray-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-400" onClick={() => handleFinalAnswer(false)}>
                No
              </button>
            </div>
          </div>
        ...
        <div className="fixed transform ease-in-out duration-1000 inset-0 bg-gray-500/50 flex justify-center items-center">
          <div className="bg-white p-4 rounded-md shadow-md">
            ...
            <div className='flex mx-auto'>
              <button className="py-2 px-4 bg-gray-500 text-white rounded-md hover:bg-gray-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-400 mt-4" onClick={() =>setShowTerms(false)}>
                Back
              </button>
              <button className="py-2 right-1 mx-10 px-4 bg-green-700 text-white rounded-md hover:bg-gray-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-400 mt-4" onClick={() =>setIsChecked(true)}>
               Accept Our Terms 
              </button>
            </div>
