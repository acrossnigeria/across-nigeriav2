...
export default function Success() { 
  ...
  return (
    <div className="h-screen w-[100%] flex flex-col bg-white">
      ...
      <div className={`${modalHeight} ${modalOpacity} transition-all duration-500 ease-in-out overflow-hidden pt-[15px] mt-auto rounded-t-[30px] border-t-1 border-t-gray-500 bg-gray-100`}>
        <div className="mx-auto text-center">
          ...
          <button className="w-[80%] md:w-[300px] h-[50px] font-semibold mx-auto text-white mt-3 text-center rounded-[30px] bg-green-600 hover:bg-green-700 active:bg-green-950" onClick={()=>(router.push('/'))}>Go Home</button>
        </div>
      </div>
    </div>
  )
