            ...
            <div className="flex flex-col gap-2 w-full">
                ...
                <div className="flex flex-row justify-between h-[480px] pt-2 items-center">
                    <div className="w-[60%] flex flex-col justify-between h-full">
                        <div className="w-full border h-[62%] rounded-[15px] bg-white shadow-lg">
                        </div>
                        <div className="w-full border h-[36%] flex flex-col gap-2 rounded-[15px] bg-white p-4 shadow-lg">
                            ...
                            <div className="flex flex-col gap-1 h-fit">
                                <span className="text-[11px] text-gray-500">Phase: <span className="font-semibold text-gray-800">September 2025</span></span>
                                <span className="text-[11px] text-gray-500">Start date: <span className="font-semibold text-gray-800">1st September</span></span>
