                    ...
                    { ageData? (
                        <div className="flex border-1 w-[100%] border-gray-500 text-[14px] flex-col mt-[10px] font-extralight">
                            ...
                            <div className="border-b-1 flex-row flex border-gray-500 text-gray-700">
                                ...
                                <div className="w-[65%] border-l-1 border-gray-500 pl-1">{`${ ageData?.list[1]} (${Math.floor((ageData?.list[0]/stats.totalUsers)*100)}%) users`}</div>
                            </div>
                            <div className="border-b-1 flex-row flex border-gray-500 text-gray-700">
                                <div className="w-[35%] pl-1">31-34</div>
                                <div className="w-[65%] border-l-1 border-gray-500 pl-1">{`${ ageData?.list[2]} (${Math.floor((ageData?.list[0]/stats.totalUsers)*100)}%) users`}</div>
                            </div>
                            <div className="border-b-1 flex-row flex border-gray-500 text-gray-700">
                                <div className="w-[35%] pl-1">35-40</div>
                                <div className="w-[65%] border-l-1 border-gray-500 pl-1">{`${ ageData?.list[3]} (${Math.floor((ageData?.list[0]/stats.totalUsers)*100)}%) users`}</div>
                            </div>
                        </div>
                    ):(
                        <div className="h-[100px] w-[100%] bg-gray-300 animate-pulse"></div>
