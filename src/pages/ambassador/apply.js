    ...
    return (
        <div className='flex flex-col pt-[20px] items-center'>
            <div className='w-[100%] md:w-[50%] h-fit flex flex-col justify-center items-center'>
                ...
                <form className='w-full flex flex-col mt-[20px]'>
                    <div className='flex flex-col  gap-1 w-[100%] px-[15px]'>
                        <label htmlFor='status'>Current status</label>
                        <select id='status' className='h-[48px] bg-gray-100 px-[10px] rounded-[5px] w-[100%]' >
                    ...
                    <div className='flex flex-col gap-1 w-[100%] mt-[25px] px-[15px]'>
                        ...
                        <input type='text' id='city' placeholder='Enter city/ town/ village' className='h-[48px] bg-gray-100 px-[10px] rounded-[5px] w-[100%]' />
                    </div>
                    <div className='px-[15px] mt-[30px] flex flex-row items-top gap-2'>
                        <input className='h-[20px] w-[20px]' value={termsAgree} onChange={(e)=>{setTermsAgree(e.target.value)}} checked={termsAgree} type='checkbox'/>
