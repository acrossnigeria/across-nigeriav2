    ...
    <Layout>
            ...
            <div className={`${isMobile?'w-[90%] ml-[5%]':'w-[60%] ml-[20%]'} mt-[25px]`}>
                ...
                <div className="mt-[30px] border-t-1 border-green-700 pt-[10px] flex flex-col text-center gap-2">
                    ...
                    <button style={{alignSelf:'center', borderRadius:'20px'}} className="bg-green-700 w-[100%] hover:text-green-700 hover:bg-transparent hover:border-2 hover:border-green-700 text-white font-bold py-[7px] text-[25px]"><Link href="/giveaway-quiz/quizSession">Play</Link></button>
                </div>
            </div>    
