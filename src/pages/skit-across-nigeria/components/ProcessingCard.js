...
const ProcessingCard = ( { handleVote, showTryAgain, voteError }) => {
    return (
        <div className="h-[300px] leading-tight p-4 pb-6 md:w-[450px] w-[90%] rounded-[5px] flex flex-col justify-center items-center gap-4 bg-white" >
            { !showTryAgain ? (
                <>
                ...
                <InfoText text={'Please wait while we process your vote.'}/>
                </>
            ) : (
                <div className="w-full h-full flex flex-col justify-center items-center">
                    <span className="text-red-600 max-w-[70%] text-center">{voteError}</span>
