...
const VoteSuccess = ( { reset, closeModal, numberOfVotes } ) => {
    return (
        <div className="transition-all ease-in-out duration-300 h-[550px] leading-tight p-4 pb-6 md:w-[450px] w-[95%] rounded-[3px] flex flex-col justify-center items-center gap-4 bg-white" >
            ...
            <Button className="mt-[70px] gap-2 w-[80%]" size="md" onClick={reset}>
