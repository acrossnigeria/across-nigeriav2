  ...
  return (
    <Layout hideNav={session?.user?.name?true:false}>
      <div className='md:ml-[5%] md:mr-[5%] bg-gray-100 mt-3'>
        ...
        { !errorGettingSkit &&
          <div>
            <button onClick={()=>{router.push('/skit-across-nigeria/pages/landing')}} className='w-[150px] border-1 ml-2 md:ml-0 border-black hover:scale-105 transition-all ease-in-out duration-250 h-[30px] bg-transparent hover:bg-gray-300 rounded-[5px] mt-2 mb-2'>How to join?</button>
            { !isGettingSkits &&
              <div className='w-[95%] md:w-full mx-auto flex flex-col bg-green-500 px-2 py-3 rounded-[3px]'>
            ...
            {  isGettingSkits &&
              <div className='w-[95%] md:w-full mx-auto flex flex-col animate-pulse bg-green-500 px-2 py-3 rounded-[5px]'>
                <div className='text-white font-semibold text-center text-[18px]'>Leader Board</div>
                <div className='mt-2 flex flex-row flex-wrap gap-2 justify-center'>
                  { [oneUser, twoUser, thirdUser].map( (_, index)=> {
                    return  <div key={index} className='bg-white rounded-[5px] shadow-lg shadow-black/50 animate-pulse items-center  w-full md:w-[300px] h-[45px]'></div>
                  })}
                </div>
                <div className='mt-3 bg-black/20 text-white p-1 rounded-[3px]'>
                  <div className='w-full flex flex-row items-center gap-3 px-2 py-1 mb-2'>
