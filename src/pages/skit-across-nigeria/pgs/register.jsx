...
export default function Register( { isRegistered }) {
  ...
  return (
        ...
        image="https://acrossnig.com/images/saImage2.png"
        canonical="https://acrossnig.com/skit-across-nigeria/pgs/register"
...
export async function  getServerSideProps(context) {
    ...
    if (userId) {
      response = await axios.get(`http://localhost:3000/api/skit-across-nigeria/auth?userId=${userId}`);
      isUserRegistered = response.data?.isUserRegistered;
      return { props: { isRegistered:isUserRegistered || null } }
    } else {
      return {
        redirect: {
            destination: '/account/login?redirect=/skit-across-nigeria/pgs/register',
            permanent: false,
        }
      };
    }
